class Node:
    def __init__(self, item, rightNode, leftNode):
        """
        Konstruktor klasy <code>Node</code> odpowiedzialny za przechowywanie informacji o lewym i prawym dziecku oraz
        danej w drzewie binarnym
        - self.item = dana
